...
class Testmodule extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Test moduleTest moduleTest moduleTest moduleTest moduleTest module Test moduleTest moduleTest module');
  ...
  /*   public function hookDisplayTop()
    {
        return '<h1>Configuration du Test Module</h1><p>Module installé avec succès !</p>'; // Message affiché dans le back-office
    } */

    public function hookDisplayMyCustomHook($params)
{
    // Votre logique ici
    return 'Hello from my custom hook! <br>';
}
}
